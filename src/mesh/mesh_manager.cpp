...
GLuint MeshManager::addShape(std::unique_ptr<All> infos)
{
    ...
    // TODO: fixme 
    vao.setVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(infos->vertexAttrib), (void*)offsetof(VertexAttrib, normal));
    vao.setVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(infos->vertexAttrib), (void*)offsetof(VertexAttrib, uv));
